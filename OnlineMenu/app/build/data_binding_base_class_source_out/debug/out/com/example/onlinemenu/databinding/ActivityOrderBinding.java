...
public final class ActivityOrderBinding implements ViewBinding {
  ...
  @NonNull
  public final RecyclerView orderres;

  private ActivityOrderBinding(@NonNull LinearLayout rootView, @NonNull RecyclerView orderres) {
  ...
  public static ActivityOrderBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      id = R.id.orderres;
      RecyclerView orderres = ViewBindings.findChildViewById(rootView, id);
      if (orderres == null) {
        break missingId;
      }

      return new ActivityOrderBinding((LinearLayout) rootView, orderres);
    }
